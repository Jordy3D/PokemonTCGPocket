...
data_series = None
for series in data:
    if series["codename"] == "P-A":
        data_series = series
        break
    
# print a list of all images in images/cards/promo-a
image_files = list(Path("images/cards/promo-a").rglob("*.png"))
for image_file in image_files:
    ...
    # 1-pokemon-name-promo-a.png
    new_name = f"{card['number']}-{card['name'].replace(' ', '-').lower()}-promo-a.png"
    ...
    os.system(f"convert images/cards/promo-a/{new_name} images/cards/promo-a/{new_webp_name}")
